...
class AllProductsSection extends Component {
  ...
  renderLoadingView = () => (
    <div className="product-loader-con">
      <Loader type="ThreeDots" color="#0b69ff" height="50" width="50" />
    </div>
  )

  renderFailureView = () => (
    <div className="product-error-view-con">
      <img
      ...
      <p className="product-failure-des">
        We are having some trouble proccessing your request.Please try again.
      </p>
    </div>
  )
